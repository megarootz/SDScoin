...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1e45f3; // addresses start with "SDS"
...
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE     = 999999; //size of block (bytes) after which reward for block calculated using block size
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V1  = 9999; //size of block (bytes) after which reward for block calculated using block size
...
const size_t   DIFFICULTY_WINDOW                             = 77; // blocks
...
const uint32_t UPGRADE_HEIGHT_V2                             = 999;
const uint32_t UPGRADE_HEIGHT_V3                             = 41900;
const uint32_t UPGRADE_HEIGHT_V4                             = 41910;
const uint32_t UPGRADE_HEIGHT_V5                             = 42000;  //June 2018
...
const char     CRYPTONOTE_NAME[]                             = "hjhcoin";
const char     GENESIS_COINBASE_TX_HEX[]                     = "013c01ff0001c096b102029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101854be30d6cda3142f224282d61bcfceb42a2e561483a7eab73f97d1b03eb9c71";
...
const uint32_t P2P_DEFAULT_CONNECTIONS_COUNT                 = 50;
